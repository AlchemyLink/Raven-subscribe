# `multi-node` — Design Doc (перевод)

> Каноническая версия этого документа — английская: [multi-node-design.md](multi-node-design.md).
> Этот русский перевод может отставать.
